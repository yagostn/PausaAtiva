...
- `docs/pesquisa.md`: Levantamento de dados sobre sedentarismo e ergonomia no ambiente de trabalho, mapeamento de dores e necessidades dos usuários, seleção de fontes confiáveis e definição das 3 principais descobertas que fundamentam o projeto.
